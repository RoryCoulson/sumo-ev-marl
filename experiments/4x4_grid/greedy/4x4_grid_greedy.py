...
if __name__ == "__main__":
    ...
    prs.add_argument("-s", dest="seconds", type=int, default=1000,  # 100000 (change in rou.xml also)
    ...
    prs.add_argument("-runs", dest="runs", type=int,
                     default=50, help="Number of runs.\n")  # number of epsiodes?
    ...
    out_csv = f"../../outputs/4x4_grid/4x4_grid/greedy"
