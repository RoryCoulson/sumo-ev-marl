...
# Update with newe run

BEST_CHECKPOINT_PATH = "../../results/2_station_strip/ppo/ppo/PPO_2_station_strip_a6eca_00000_0_2023-04-19_18-14-34/checkpoint_000125"
...
if __name__ == "__main__":
    ...
    register_env(
        ...
        lambda _: PettingZooEnv(
            env(
                ...
                out_csv_name="../../outputs/2_station_strip/ppo/best/best_run",
                use_gui=True,
    ...
    out_csv = f"../../outputs/2_station_strip/ppo/ppo_best_checkpoint/{experiment_time}_alpha{args.alpha}_gamma{args.gamma}_eps{args.epsilon}_decay{args.decay}"
