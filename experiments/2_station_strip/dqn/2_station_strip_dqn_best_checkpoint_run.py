...
if __name__ == "__main__":
    ...
    register_env(
        ...
        lambda _: PettingZooEnv(
            env(
                ...
                out_csv_name="outputs/2_station_strip/dqn/best/best_run",
                use_gui=True,
    ...
    out_csv = f"../../outputs/2_station_strip/dqn/best/dqn_best_checkpoint/{experiment_time}_alpha{args.alpha}_gamma{args.gamma}_eps{args.epsilon}_decay{args.decay}"
