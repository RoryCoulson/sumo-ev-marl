...
if __name__ == "__main__":
    ...
    prs.add_argument("-gui", action="store_true", default=True,
    ...
    out_csv = f"../../outputs/4_station_strip/dqn/dqn_best_checkpoint/{experiment_time}_alpha{args.alpha}_gamma{args.gamma}_eps{args.epsilon}_decay{args.decay}"
