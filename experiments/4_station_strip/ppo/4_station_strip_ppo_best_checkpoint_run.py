...
# Update with new run
BEST_CHECKPOINT_PATH = "../../results/4_station_strip/ppo/ppo/PPO_4_station_strip_3251a_00000_0_2023-04-18_20-21-21/checkpoint_000625"
...
if __name__ == "__main__":
    ...
    out_csv = f"../../outputs/4_station_strip/ppo/ppo_best_checkpoint/{experiment_time}_alpha{args.alpha}_gamma{args.gamma}_eps{args.epsilon}_decay{args.decay}"
