...
import sumo_ev_rl
from sumo_ev_rl import env, parallel_env


PATH = os.path.dirname(sumo_ev_rl.__file__)
...
def grid4x4(parallel=True, **kwargs):
    ...
    kwargs.update(
        {
            "net_file": PATH + "/net_dir_path + "nets
            / RESCO/grid4x4/grid4x4.net.xml",
            "route_file": PATH + "/net_dir_path + "nets
            / RESCO/grid4x4/grid4x4_1.rou.xml",
            "num_seconds": 3600,
        }
    )
    if parallel:
...
def arterial4x4(parallel=True, **kwargs):
    ...
    kwargs.update(
        {
            "net_file": PATH + "/net_dir_path + "nets
            / RESCO/arterial4x4/arterial4x4.net.xml",
            "route_file": PATH + "/net_dir_path + "nets
            / RESCO/arterial4x4/arterial4x4_1.rou.xml",
            "num_seconds": 3600,
        }
    )
    if parallel:
...
def cologne1(parallel=True, **kwargs):
    ...
    kwargs.update(
        {
            "net_file": PATH + "/net_dir_path + "nets
            / RESCO/cologne1/cologne1.net.xml",
            "route_file": PATH + "/net_dir_path + "nets
            / RESCO/cologne1/cologne1.rou.xml",
            "begin_time": 25200,
            "num_seconds": 28800,
        }
    )
...
def cologne3(parallel=True, **kwargs):
    ...
    kwargs.update(
        {
            "net_file": PATH + "/net_dir_path + "nets
            / RESCO/cologne3/cologne3.net.xml",
            "route_file": PATH + "/net_dir_path + "nets
            / RESCO/cologne3/cologne3.rou.xml",
            "begin_time": 25200,
            "num_seconds": 28800,
        }
    )
...
def cologne8(parallel=True, **kwargs):
    ...
    kwargs.update(
        {
            "net_file": PATH + "/net_dir_path + "nets
            / RESCO/cologne8/cologne8.net.xml",
            "route_file": PATH + "/net_dir_path + "nets
            / RESCO/cologne8/cologne8.rou.xml",
            "begin_time": 25200,
            "num_seconds": 28800,
        }
    )
...
def ingolstadt1(parallel=True, **kwargs):
    ...
    kwargs.update(
        {
            "net_file": PATH + "/net_dir_path + "nets
            / RESCO/ingolstadt1/ingolstadt1.net.xml",
            "route_file": PATH + "/net_dir_path + "nets
            / RESCO/ingolstadt1/ingolstadt1.rou.xml",
            "begin_time": 57600,
            "num_seconds": 61200,
        }
    )
...
def ingolstadt7(parallel=True, **kwargs):
    ...
    kwargs.update(
        {
            "net_file": PATH + "/net_dir_path + "nets
            / RESCO/ingolstadt7/ingolstadt7.net.xml",
            "route_file": PATH + "/net_dir_path + "nets
            / RESCO/ingolstadt7/ingolstadt7.rou.xml",
            "begin_time": 57600,
            "num_seconds": 61200,
        }
    )
...
def ingolstadt21(parallel=True, **kwargs):
    ...
    kwargs.update(
        {
            "net_file": PATH + "/net_dir_path + "nets
            / RESCO/ingolstadt21/ingolstadt21.net.xml",
            "route_file": PATH + "/net_dir_path + "nets
            / RESCO/ingolstadt21/ingolstadt21.rou.xml",
            "begin_time": 57600,
            "num_seconds": 61200,
        }
    )
